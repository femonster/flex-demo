...
var slider = {
    ...
    setprogress:function(originItem,item,index,circle,percent,perimeter,boxW,boxH){
        ...
        if(!!percent){
            // console.log("获取！",!originItem.dataset.blobUrl);
    ...
    render: function(p, sArr,achild) {
        ...
        // function setprogress(index,circle,percent,perimeter){
        //     if(percent!=1){
        //         circle.setAttribute("stroke-dasharray", perimeter * percent + " " + perimeter * (1 - percent));
        //         setprogress(circle,nodes[index].percent,nodes[index].perimeter);
        //     }else{
        ...
        aLi.forEach(function(item, index) {
            if (item.dataset.isload == 0) {
                ...
                console.log(originItem,percent,perimeter);
